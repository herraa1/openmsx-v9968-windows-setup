...
V9968 対応 openMSX 派生版を Windows にセットアップする非公式の補助ツールです。バージョンは **0.7.2**。openMSX 本体や V9968 開発元の公式プロジェクトではありません。
...
| V9968 TECH DEMO — Scene 3：水面の揺らぎと3Dアニメーション。 |
| --- |
| ![V9968 TECH DEMO — Scene 3の水面効果](demos/v9968-tech-demo/water-preview.gif) |
...
1. [GitHub Releases](https://github.com/renatus-xxxx/openmsx-v9968-windows-setup/releases) の **Assets** から `openmsx-v9968-windows-setup-0.7.2.zip` をダウンロードし、ZIP **全体**を、OneDrive などの同期フォルダの外にある新しい書込み可能なフォルダ（例: `C:\MSX`）へ展開します。ZIP 内から直接 BAT を実行しないでください。
